...
function areaChart(figure, chartAttr, chartData) {
    ...
    nv.addGraph(function () {
        chart = nv.models.stackedAreaChart()
            ...
            .duration(100)
            .margin({"left":200, "bottom":50, "right":75});
        ...
        // d3.selectAll(".nv-controlsWrap").attr("transform","translate(300, 0)");
        // d3.selectAll(".nv-legendWrap").attr("transform","translate(-500, 0)");
